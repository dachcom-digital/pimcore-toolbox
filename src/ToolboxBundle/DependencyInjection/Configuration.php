                ...
                ->arrayNode('theme')
                    ->children()
                        ...
                        ->arrayNode('wrapper')
                            ...
                            ->beforeNormalization()
                                ->ifTrue(function ($v) { return is_array($v) && !isset($v['wrapperClasses']); })
                                ->then(function ($v) { return array('wrapperClasses' => $v); })
                            ->end()
                                ->children()
                                    ->arrayNode('wrapperClasses')
                                        ->prototype('array')
                                            ->children()
                                                ->scalarNode('tag')->end()
